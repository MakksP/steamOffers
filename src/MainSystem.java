...
public class MainSystem {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String staticUrlPart = "https://steamcommunity.com/market/search?q=#";

        for (int currentPageIndex = 0; currentPageIndex < NUMBER_OF_PAGES; currentPageIndex++){
            URL currentItemUrl = new URL(staticUrlPart + currentPageIndex + SORTING);
